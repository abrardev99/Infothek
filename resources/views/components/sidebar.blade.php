<div class="c-sidebar c-sidebar-dark c-sidebar-fixed c-sidebar-lg-show" id="sidebar">
    <div class="c-sidebar-brand d-lg-down-none">
        <a href="{{ url('/') }}"><img src="{{ asset('frontend/images/logo.png') }}" class="c-sidebar-brand-full" width="118" height="46" alt="PromoBulls Logo"></a>
    </div>
    <ul class="c-sidebar-nav">
        <li class="c-sidebar-nav-item"><a class="c-sidebar-nav-link" href="{{ auth()->user()->dashboardUrl() }}">
