                        ...
                        <div class="row">
                                    ...
                                    <select name="category_id"
                                        ...
                                        @forelse($categories as $category)
                                            ...
                                            @foreach($category->childCategories as $childCategory)
                                                <option value="{{ $childCategory->id }}" {{ $category->category_id == $childCategory->id ? 'selected' : '' }}>&nbsp;-- {{ $childCategory->name }}</option>
                                            @endforeach
                            ...
                            <div class="col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="description" id="description" type="text" value="{{ $category->description }}"
